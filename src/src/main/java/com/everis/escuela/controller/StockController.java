...
public class StockController {
    ...
    @PostMapping("stock")
    public List<SaveStockResponseDto> save (@RequestBody List<SaveStockRequestDto> saveStockRequestDtoList) throws BusinessException {
        return StockMapper.INSTANCE.toSaveStockResponseDto(stockService
                        .save(StockMapper.INSTANCE.toEntity(saveStockRequestDtoList)));
    }
}
